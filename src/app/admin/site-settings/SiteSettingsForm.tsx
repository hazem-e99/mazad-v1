...
export function SiteSettingsForm({ initial, canEdit }: { initial: SiteSettingsDTO; canEdit: boolean }) {
    ...
    <form onSubmit={onSubmit} className="flex flex-col gap-6">
      ...
      {canEdit && (
        <div className="sticky bottom-4 z-10 flex justify-end">
          <Button type="submit" variant="gold" size="lg" loading={saving} disabled={saving || !canEdit}>
