...
export const AUDIT_ACTION_LABELS_AR: Record<AuditAction, string> = {
  ...
  "listing.created": "إنشاء لوحة معروضة",
  ...
  "plate.created": "إضافة لوحة",
  "plate.updated": "تعديل لوحة",
  "plate.hidden": "إخفاء لوحة",
  "plate.shown": "إظهار لوحة",
  "plate.deleted": "حذف لوحة",
  "ad.activated": "تفعيل إعلان",
  "ad.deactivated": "إيقاف إعلان",
  ...
  "chat.cleared": "مسح الدردشة بالكامل",
...
export const AUDIT_ACTION_LABELS_EN: Record<AuditAction, string> = {
  ...
  "plate.created": "Plate created",
  "plate.updated": "Plate updated",
  "plate.hidden": "Plate hidden",
  "plate.shown": "Plate shown",
  "plate.deleted": "Plate deleted",
  "ad.activated": "Ad activated",
  "ad.deactivated": "Ad deactivated",
  ...
  "chat.cleared": "Entire chat cleared",
