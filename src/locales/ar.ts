...
const ar: MessageCatalog = {
  ...
  pages: {
    ...
    plateImageRequired: "صورة اللوحة الفعلية (اختياري)",
    ...
    ownershipDocumentLabel: "إستمارة السيارة (اختياري)",
    ownershipDocumentHint: "ارفع صورة واضحة من إستمارة السيارة لإثبات ملكية اللوحة (اختياري).",
